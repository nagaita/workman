 ...
 */
@Configuration
@ComponentScan(value="io.nagaita.workman.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new io.nagaita.workman.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new io.nagaita.workman.dbflute.allcommon.ImplementedInvokerAssistant();
    }
